...
public final class transform implements Comparable, Serializable
{
    ...
    private location objLocation;  // To store the object's location
    ...
    // Constructor to set both location and rotation values
    public transform(location loc, float rotX, float rotY, float rotZ, float rotW)
    {
    ...
    public transform(float rotX, float rotY, float rotZ, float rotW)
    {
        matrix = new float[3][4];
        matrix[0][0] = rotX;
        matrix[0][1] = rotY;
