...
{
    public static final String QUEST_TOOL_TITLE = "Quest Tool";
    ...
    public int OnSpeaking(obj_id self, String text) throws InterruptedException
    {
        if (isIdValid(self))
        {
            if ((toLower(text)).equals("tally-ho!"))
            {
    ...
    public int revokeQuestHandler(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        sendSystemMessageTestingOnly(self, String.valueOf(params));
